...
module.exports = (tickets, eventConfig) => {
  numeral.defaultFormat('0.00')
    ...
    const netTicketPrice = (price / 1.27) - catering;
      ...
      netUnitPrice: numeral(netTicketPrice).format(), // calculates gross and net values from per item net
      comment: title
    })
    items.push({
      ...
      unit: 'qt',
      vat: 27, // can be a number or a special string
      netUnitPrice: numeral(catering).format(), // calculates gross and net values from per item net
